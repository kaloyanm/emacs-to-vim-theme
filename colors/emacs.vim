...
call s:hi('Type', 'forest_green', 'unspecified_bg', 'none')
call s:hi('Special', 'violet_red4', 'unspecified_bg', 'none')
call s:hi('Underlined', 'royalblue3', 'unspecified_bg', 'underline')
...
call s:hi('ErrorMsg', 'red1', 'unspecified_bg', 'none')
call s:hi('WarningMsg', 'darkorange', 'unspecified_bg', 'none')
call s:hi('MoreMsg', 'forest_green', 'unspecified_bg', 'none')
